...
export class GlobalAccount {
  ...
  public completeMinTokenReserves: bigint;
  ...
  constructor(
    ...
    completeMinTokenReserves: bigint,
    ...
    this.completeMinTokenReserves = completeMinTokenReserves;
  ...
  public static fromBuffer(buffer: Buffer): GlobalAccount {
    ...
    return new GlobalAccount(
      ...
      BigInt(value.completeMinTokenReserves),
